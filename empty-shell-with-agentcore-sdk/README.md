# Empty Shell with AgentCore SDK

A minimal Amazon Bedrock AgentCore runtime that echoes back the received payload. Uses the `bedrock-agentcore` Python SDK to abstract AgentCore's HTTP interface. 
