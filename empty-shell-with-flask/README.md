# Empty Shell with Flask

A minimal Amazon Bedrock AgentCore runtime that echoes back the received payload. Uses Flask to implement AgentCore's HTTP interface. 
